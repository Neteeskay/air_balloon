...
export type Result = { roundId: string; result: 'WIN' | 'LOSS'; betAmount: number; cashoutMultiplier?: number; crashMultiplier: number; winAmount: number; potentialWinAmount?: number; score: number; playerCharacter: PlayerCharacter; reward?: { type: string; rarity: string } }
