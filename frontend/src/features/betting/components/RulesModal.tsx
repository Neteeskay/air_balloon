    ...
    <Modal className="rules-modal" onClose={onClose} title="Правила игры">
      <div className="rules-content">
        <ol className="rules-list">
          ...
          <li><b>Собирай пазлы.</b> За успешный cashout ты получаешь фрагмент пазла. Собери пазл полностью, чтобы открыть предмет одежды для шиншиллы, а затем надень его в профиле.</li>
        </ol>
