        ...
        <div className="hero" ref={heroContentRef}>
          <div className="hero__copy">
            ...
            <div className="hero__cta-row">
              <button className="hero__cta" type="button" onClick={onPlay}>{CONTENT.hero.cta}</button>
              <button
                className="hero__how"
                type="button"
                onClick={() => screen2Ref.current?.scrollIntoView({ behavior: 'smooth' })}
              >
                {CONTENT.hero.howToPlay}
              </button>
            </div>
          </div>
        ...
        <div className="modes" ref={screen3ContentRef}>
          ...
          <div className="modes__list">
            <div className="modes__mode modes__mode--green">
              ...
              <button className="modes__mode-cta modes__mode-cta--green" type="button" onClick={onPlay} aria-label="Выбрать спокойный режим">
            ...
            <div className="modes__mode modes__mode--red">
              ...
              <button className="modes__mode-cta modes__mode-cta--red" type="button" onClick={onPlay} aria-label="Выбрать рискованный режим">
