...
отсутствуют. Позиция `boosterLevel` для x2/x3/x4 уже видна в игровом DTO:
она выбрана до старта и связана тем же commitment, но не раскрывает crash.
Cashout не разрешает reveal: шар ещё продолжает полёт.
