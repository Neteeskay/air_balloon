...
- Published integration commit: `d2b0f12` (branch tip additionally contains this report metadata commit)
...
- `npm run build`: PASS
- `backend/mvnw.cmd -q verify`: PASS (exit code 0; Docker/Testcontainers integration suite completed).
