    ...
    public ConfigMetadataResponse metadata() {
        return new ConfigMetadataResponse(
                ...
                List.of(
                        ...
                        param("crash.alpha", "Alpha", "House edge / distribution skew parameter", "number", null,
                                0.0, 1.0, 0.85, true, true, "crash", "probability", null,
                                "Higher alpha increases house advantage in the crash curve"),
                        param("crash.minCrashMultiplier", "Min crash multiplier", "Guaranteed minimum multiplier", "number", "x",
                                ...
                                "Engine piecewise crash formula requires a value <= 1 (fixed range min==max)"),
                        ...
                        param("crash.multiplierGrowthRate", "Multiplier growth rate", "Growth rate between frames", "number", null,
