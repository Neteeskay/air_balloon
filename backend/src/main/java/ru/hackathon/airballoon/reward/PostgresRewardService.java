...
public class PostgresRewardService implements RewardService {
    ...
    public PostgresRewardService(JdbcTemplate jdbc,RoundRepository rounds,PuzzleRewardService puzzleRewards) {
        this.jdbc=jdbc; this.rounds=rounds; this.puzzleRewards=puzzleRewards;
    }
    ...
    public Reward generateReward(GameRound supplied) {
        ...
        // The legacy random row remains an internal compatibility receipt. Only this new reward is player-facing.
        puzzleRewards.grantForWinningRound(r);
