...
import ru.hackathon.airballoon.reward.Reward;
...
class HistoryServiceTest {
    @Test void resultDtoContainsStableBackendCharacter() {
        ...
        Reward reward = new Reward(UUID.randomUUID(), roundId, userId, "CLOUD", "COMMON", completedAt);
        ...
        when(rewards.findByRound(roundId)).thenReturn(Optional.of(reward));
